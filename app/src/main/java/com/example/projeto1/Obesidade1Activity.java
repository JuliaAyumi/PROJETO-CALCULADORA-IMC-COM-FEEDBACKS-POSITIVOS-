...
public class Obesidade1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textResultadoObesidade1=findViewById(R.id.textResultadoObesidade1);
        textResultadoObesidade1.setText(exibe);

        Button btnBackObesidade1 =findViewById(R.id.btnBackObesidade1);
        btnBackObesidade1.setOnClickListener(view -> {
