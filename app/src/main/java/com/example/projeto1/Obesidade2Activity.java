...
public class Obesidade2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textResultadoObesidade2=findViewById(R.id.textResultadoObesidade2);
        textResultadoObesidade2.setText(exibe);

        Button btnBackObesidade2 =findViewById(R.id.btnBackObesidade2);
        btnBackObesidade2.setOnClickListener(view -> {
