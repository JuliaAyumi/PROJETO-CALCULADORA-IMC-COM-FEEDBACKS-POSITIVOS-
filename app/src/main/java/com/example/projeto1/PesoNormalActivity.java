...
public class PesoNormalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textResultadoNormal=findViewById(R.id.textResultadoNormal);
        textResultadoNormal.setText(exibe);

        Button btnBackNormal =findViewById(R.id.btnBackNormal);
        btnBackNormal.setOnClickListener(view -> {
